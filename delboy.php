...
<div class="col-md-8">
  <div class="panel panel-success">
    <div class="panel-heading" align="center"><b>Deliveryboy Details</b></div>
...
<?php } ?>   
  ...
  <div class="wrapper">
  <button onclick="window.location='admin.php'" class="btn btn-success" type="submit" >Back</button>
  </div>
    </div>
  </div>
</div>
