...
<form id="form1" action="#myModal1" method="POST">
  ...
  <div class="form-group has-feedback">
    ...
    <input type="email" class="form-control" id="email" name="email" placeholder="Email"  pattern="[a-zA-Z0-9]{1-30}@gmail.com" required>
...
<img src="images/logo.png" style="float:right;width:800px;height:500px;" alt="A comfortable shuttle ride round the corner">
</form>
</div>
</div>
</div>
...
<div class="w3-container w3-2018-sailor-blue w3-hover-black w3-animate-bottom" id="adv">
  ...
  <p>Save your time by tracking </p>
</div>
</div>
</div>
  ...
  if (mysqli_num_rows($result1)>0)
    {
       ...
       echo '<script type="text/javascript">
        window.location="http://localhost/Threads/user.php";
      </script>';
    } 
  else if (mysqli_num_rows($result2)>0)
    {
       ...
       echo '<script type="text/javascript">
        window.location="http://localhost/Threads/admin.php";
      </script>';
    } 
  else 
    {
        echo '<script type="text/javascript">
        window.location="http://localhost/Threadshomepage.php";
      </script>'; 
    }   
  unset ($_POST['login']);
}
