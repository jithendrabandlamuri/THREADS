...
<!--header-->
  ...
  <div class= "collapse navbar-collapse navbar-right" id="bs-shuttle-navbar-collapse-1">
    ...
    <li type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Cart</li>
	  <li> <a class="logout" style="background-color: lightblue;color: red" href="./homepage.php"> Logout </a> </li>
    </ul>
    </div>  
  </div>
</nav>
...
<div class="row">
  <br>
    ...
    <center><button onclick="location.href='http://localhost/Threads/book.php'" type="button" class="btn btn-primary" value="exit">
     Back</button></center>
   <br>
   <br>
   <div class= "wrapper">
...
<div class="container" style="width:700px;">  
                ...
                <?php  
                $query = "SELECT * FROM thread_products ORDER BY id ASC";  
                ...
                <div style="align-content: left;" class="col-md-4">  
                     <form method="post" style="width: 200px;" action="book1.php?action=add&id=<?php echo $row["id"]; ?>"> 
                          ...
                          <div style="border:1px solid black;float: left; width: 100%; padding:10 30px; background-color:#f1f1f1; border-radius:5px; padding:16px;margin: 20px" align="center">  
                            <br>
                               <img style="width: 250px; height: 150px;" src="thread_products/<?php echo $row["image"]; ?>" class="img-responsive" /><br />  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="book1.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
