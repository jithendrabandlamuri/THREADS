...
<div class= "panel panel-body detail">
   ...
   <br>
   <div class= "wrapper">
   <button onclick="location.href='http://localhost/Threads/book.php'" type="button" class="btn btn-success" value="Order">
     Order</button>
   </div>
      </div>
    </div>
...
<div class="col-md-8">
  <div class="panel panel-success">
    ...
    <a href="GPS_admin.php"><h5 style="color:black;">Order Tracking</h5></a>
    </div>
  </div>
</div>
</div>
