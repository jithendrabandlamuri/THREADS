...
<div class="col-md-8">
  <div class="panel panel-success">
    ...
    <a href="no_shuttle.php"><h5 style="color:black;">Deliveryboy Details</h5></a>
    <a href="shut.php"><h5 style="color:black;">View the number of orders waiting</h5></a>	
    <div class="wrapper">
    <button onclick="location.href='http://localhost/Threads/admin.php'" type="button" class="btn btn-primary" value="back">Back</button>  </div>
    </div>
  </div>
</div>
</div>
